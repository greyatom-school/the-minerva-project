...
- **OR** Watch and learn from this ene to end tutorial on [how to make REST API calls with examples using fetch](https://www.youtube.com/watch?v=Oive66jrwBs&t=118s)
