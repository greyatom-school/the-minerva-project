...
This section will help you understand the language that is used to set up the structure of the web page rendered onn the browser.
...
We have already covered this topic in our introductory sprint. You can consider this section as a part of a revision.
...
- Please read about the [best practices of HTML](https://www.w3schools.com/html/html5_syntax.asp).
...
- Read about [elements and types of HTML elements](https://www.javatpoint.com/html-elements)
...
In this unit, we learnt what's HTML and HTML elements, tags and attributes. This is the building block of building the structure of a web site or app. It is impossible to build websites or apps without HTML elements and attributes. You'd using it in our exercises as well.
